...
#+HEADERS: :tangle /sftp:austin.skeeters@cms07.hep.fsu.edu:/storage/6/work/askeeters/HSCPStudy/HSCP_Analyzers/MC_Analyzer.cpp :noweb tangle
#+BEGIN_SRC cpp
<<MC_Analyzer.cpp>>
#+END_SRC

#+NAME: MC_Analyzer.cpp
#+HEADERS: :dir /ssh:austin.skeeters@cms07.hep.fsu.edu:/storage/6/work/askeeters/HSCPStudy/HSCP_Analyzers/ :flags `root-config --cflags` :flags `root-config --glibs` :flags -lEG
#+BEGIN_SRC cpp 
#include <stdio.h>
#include <iostream>
#include <sstream>
