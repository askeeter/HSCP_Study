...
#+RESULTS: MC_Analyzer
: Configuration script for Geant4 binary releases at CERN, Version 1.2 December 2005
: g++ (GCC) 4.3.4 Copyright (C) 2008 Free Software Foundation, Inc. This is free software; see the source for copying conditions. There is NO warranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
: Setting up the environment for geant4.9.4.p04
: Setting G4WORKDIR
