...
* TODO Things to do [3/9]                                            :export:
  ...
  - [-] Add to primitive distributions
    - [-] recoMassCorr
    - [-] recoMassUncorr
    - [-] genMass
    - [-] recoPCorr / recoPtCorr
    - [-] recoPUncorr / recoPtUncorr
    - [-] genP / Pt
  - [-] Update AllocateDistributions function to exclude respective
    gen/reco variables for reco/gen distributions, respectively
  - [-] Plot reco mass distributions [0/2]
    - [-] With knowing correct charge
    - [-] Without knowing correct charge
  - [-] Plot reco mass vs gen mass [0/2]
    - [-] With knowing correct charge
    - [-] Without knowing correct charge
  - [-] Plot TOF for gen particles
  - [-] Plot Beta for gen and reco particles [0/2]
    - [-] 1/TOF for reco particles
    - [-] PC/E for gen particles
  - [ ] Plot Beta reco vs beta gen (1/TOF reco) (PC/E gen) [0/2]
    - [ ] Mass scan for a fixed charge
    - [ ] Charge scan for a fixed mass
  - [-] Fix how mass is calculated. Different for gen and reco. Gen
    just use known.
