...
# with command line options: Configuration/GenProduction/python/ThirteenTeV/HSCPmchamp3_M_2200_TuneZ2star_13TeV_pythia6_cff.py --fileout file:mchamp3_M_2200_AOD.root --mc --eventcontent AODSIM --datatier GEN-SIM-DIGI-AOD --conditions MCRUN2_74_V8 --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun,RAW2DIGI,L1Reco,RECO --python_filename mchamp3_M_2200_cfg.py --magField 38T_PostLS1 --geometry Extended2015 --customise SimG4Core/CustomPhysics/Exotica_HSCP_SIM_cfi.customise,SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1 --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/ThirteenTeV/HSCPmchamp3_M_2200_TuneZ2star_13TeV_pythia6_cff.py nevts:1000'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:mchamp3_M_2200_AOD.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0          ! User defined processes', 
            ...
            'CKIN(1)=2200.000000 !min sqrt(s hat)', 
            'CKIN(2)= -1  ! (no) max sqrt(s hat) (GeV)', 
            'KCHG(17,1)=3 !charge of tauprime', 
            'PMAS(17,1)=2200.000000 !tauprime mass', 
    ...
    massPoint = cms.untracked.int32(2200),
    maxEventsToPrint = cms.untracked.int32(0),
    particleFile = cms.untracked.string('Configuration/Generator/data/particles_HIP3_stau_2200_GeV.txt'),
    pdtFile = cms.FileInPath('Configuration/Generator/data/hscppythiapdtHIP3stau2200.tbl'),
